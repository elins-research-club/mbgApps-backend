...
const generateNutrition = async (req, res) => {
  try {
    ...
    const rekomendasi = await getAllRecommendation(detailBahanForLp);
...
async function editMenu(req, res) {
  try {
    ...
    console.log(`📝 [Backend] Editing menu ID: ${id}`, {
      nama,
      kategori,
      resep,
    });
